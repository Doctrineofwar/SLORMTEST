...
let ConfigComponent = class ConfigComponent extends abstract_unsubscribe_component_1.AbstractUnsubscribeComponent {
    constructor(buildStorageService) {
        super();
        this.buildStorageService = buildStorageService;
        this.EXTRA_VALIDATORS = {
            percent_missing_health: [forms_1.Validators.max(100)],
            percent_missing_mana: [forms_1.Validators.max(100)],
            enemy_percent_missing_health: [forms_1.Validators.max(100)],
            block_stacks: [forms_1.Validators.max(100)],
            nimble_champion_stacks: [forms_1.Validators.max(200)],
            nimble_chaserenitympion_stacks: [forms_1.Validators.max(12)]
        };
        this.NON_REQUIRED_CONFIGURATION = ['maxed_upgrades'];
        this.GENERAL_CONFIG_GROUPS = [
            {
                title: 'General',
                condition: () => true,
                configurations: [
        ...
        this.EQUIPMENT_CONFIG_GROUPS = [
            ...
            {
                title: 'Reaper (Unity)',
                condition: character => _slorm_api_1.UNITY_REAPERS.includes(character.reaper.id),
                configurations: [
            ...
            {
                title: 'Willpower',
                condition: character => this.isAttributeAllocated(character, _slorm_api_1.Attribute.Willpower),
                configurations: [
            ...
            {
                title: 'Dexterity',
                condition: character => this.isAttributeAllocated(character, _slorm_api_1.Attribute.Dexterity),
                configurations: [
            ...
            {
                title: 'Bravery',
                condition: character => this.isAttributeAllocated(character, _slorm_api_1.Attribute.Bravery),
                configurations: [
        ...
        this.CLASS_CONFIG_GROUPS = [
            {
                title: 'Knight',
                condition: character => character.heroClass === _slorm_api_1.HeroClass.Warrior,
                configurations: [
            ...
            {
                title: 'Banner of War',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 0),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 2),
                configurations: [
            ...
            {
                title: 'Mighty Swing',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 3),
                configurations: [
            ...
            {
                title: 'Wood Stick',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 4),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 5),
                configurations: [
            ...
            {
                title: 'Cadence',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 6),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 7),
                configurations: [
            ...
            {
                title: 'Whirlwind',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 9),
                configurations: [
            ...
            {
                title: 'Elder Lance',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Warrior, 10),
                configurations: [
            ...
            {
                title: 'Huntress',
                condition: character => character.heroClass === _slorm_api_1.HeroClass.Huntress,
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 0),
                configurations: [
            ...
            {
                title: 'Tumble',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 1),
                configurations: [
            ...
            {
                title: 'Smoke screen',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 2),
                configurations: [
            ...
            {
                title: 'Arrow Shot',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 3),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 4),
                configurations: [
            ...
            {
                title: 'Stab',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 5),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 7),
                configurations: [
            ...
            {
                title: 'Void Arrow',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 8),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Huntress, 10),
                configurations: [
            ...
            {
                title: 'Mage',
                condition: character => character.heroClass === _slorm_api_1.HeroClass.Mage,
                configurations: [
            ...
            {
                title: 'Wall of Omen',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 0),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 2),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 4),
                configurations: [
            ...
            {
                title: 'Book Smash',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 5),
                configurations: [
            ...
            {
                title: 'Rift Nova',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 6),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 7),
                configurations: [
            ...
            },
            {
                ...
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 8),
                configurations: [
                    { type: 'enum', key: 'attunment_pulse_current_school', label: 'Current school', values: [{ value: _slorm_api_1.SkillGenre.Arcanic, label: 'Arcanic' }, { value: _slorm_api_1.SkillGenre.Temporal, label: 'Temporal' }, { value: _slorm_api_1.SkillGenre.Obliteration, label: 'Obliteration' }] },
            ...
            {
                title: 'Arcane Breach',
                condition: character => this.isSkillEquipped(character, _slorm_api_1.HeroClass.Mage, 9),
                configurations: [
    ...
    generateConfigurationForm() {
        ...
        const configEntries = Object.entries(build !== null ? build.configuration : _slorm_api_1.DEFAULT_CONFIG);
        for (const entry of configEntries) {
            const [name, value] = entry;
            let validators = [...(0, _slorm_api_1.valueOrDefault)(this.EXTRA_VALIDATORS[name], [])];
            if (!this.NON_REQUIRED_CONFIGURATION.includes(name)) {
                validators.push(forms_1.Validators.required);
            }
            if (typeof value === 'number') {
                validators.push(forms_1.Validators.min(0));
            }
            formData[name] = new forms_1.FormControl(value, validators);
        }
        return new forms_1.FormGroup(formData);
    }
    updateConfiguration() {
        if (this.config !== null) {
            Object.keys(this.config.controls).forEach(key => {
                const controlErrors = this.config.get(key).errors;
    ...
    getControl(entry) {
        return this.config === null ? null : this.config.get(entry.key);
    }
    isGroupValid(group) {
        const layer = this.buildStorageService.getLayer();
        return layer !== null && group.condition(layer.character);
    }
    hasActivable(character, id) {
        const activables = [
            ...character.reaper.activables,
            ..._slorm_api_1.ALL_GEAR_SLOT_VALUES.map(slot => character.gear[slot]?.legendaryEffect?.activable).filter(_slorm_api_1.isNotNullOrUndefined)
        ];
        return activables.some(activable => activable.id === id);
    }
    isSkillEquipped(character, heroClass, id) {
    ...
    isAttributeAllocated(character, attribute) {
        const att = character.attributes.allocated[attribute];
        return att.rank > 0;
    }
    isAncestralLegacyEquipped(character, ancestralLegacy) {
        return character.ancestralLegacies.activeAncestralLegacies.includes(ancestralLegacy);
    }
    hasLegendaryEffect(character, legendaryId) {
        return _slorm_api_1.ALL_GEAR_SLOT_VALUES.map(slot => character.gear[slot]?.legendaryEffect)
            .filter(_slorm_api_1.isNotNullOrUndefined)
