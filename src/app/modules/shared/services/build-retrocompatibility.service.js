...
exports.BuildRetrocompatibilityService = void 0;
const core_1 = require("@angular/core");
const _slorm_api_1 = require("@slorm-api");
let BuildRetrocompatibilityService = class BuildRetrocompatibilityService {
    constructor() {
        this.CHANGES = [
            {
                version: '0.0.2',
            ...
            },
            {
                ...
                update: build => {
                    ...
                    for (const layer of build.layers) {
                        ...
                        layer.character.version = _slorm_api_1.GAME_VERSION;
                    }
            ...
            },
            {
                ...
                update: build => {
                    ...
                    if ('all_characters_level' in build.configuration) {
                        build.configuration.all_characters_level = undefined;
            ...
            },
            {
                ...
                update: build => {
                    ...
                    if (build.configuration.chilled_enemy_nearby === undefined) {
                        build.configuration.chilled_enemy_nearby = _slorm_api_1.DEFAULT_CONFIG.chilled_enemy_nearby;
                    }
                    if (build.configuration.in_combat === undefined) {
                        build.configuration.in_combat = _slorm_api_1.DEFAULT_CONFIG.in_combat;
                    }
                }
            },
            {
            ...
            },
            {
                ...
                update: build => {
                    build.version = '0.2.0';
                    for (const layer of build.layers) {
                        layer.character.reaper.baseAffinity = _slorm_api_1.MAX_REAPER_AFFINITY_BASE;
            ...
            },
            {
                ...
                update: build => {
                    ...
                    for (const layer of build.layers) {
                        const baseAffinity = layer.character.reaper.affinity;
            ...
            },
            {
                ...
                update: build => {
                    build.version = '0.7.0';
                    build.configuration.ray_of_obliteration_power = build.configuration['ray_of_obliteration_grow_stacks'];
                    build.configuration.recent_delighted_arrow_shot = false;
                    build.configuration.unrelenting_stacks = 0;
                    delete build.configuration.unity_level_0_47_p;
                    delete build.configuration.unity_level_0_48_p;
                    delete build.configuration.unity_level_0_49_p;
                    delete build.configuration.unity_level_0_50_p;
                    delete build.configuration.unity_level_0_51_p;
                    delete build.configuration.unity_level_0_52_p;
                    delete build.configuration.unity_level_1_47_p;
                    delete build.configuration.unity_level_1_48_p;
                    delete build.configuration.unity_level_1_49_p;
                    delete build.configuration.unity_level_1_50_p;
                    delete build.configuration.unity_level_1_51_p;
                    delete build.configuration.unity_level_1_52_p;
                    delete build.configuration.unity_level_2_47_p;
                    delete build.configuration.unity_level_2_48_p;
                    delete build.configuration.unity_level_2_49_p;
                    delete build.configuration.unity_level_2_50_p;
                    delete build.configuration.unity_level_2_51_p;
                    delete build.configuration.unity_level_2_52_p;
                    for (const layer of build.layers) {
                        while (layer.character.sharedInventory.length < _slorm_api_1.STASH_TABS_COUNT) {
                            layer.character.sharedInventory.push((0, _slorm_api_1.list)(_slorm_api_1.STASH_SIZE).map(() => null));
                        }
                    }
                }
            },
    ...
    updateToLatestVersion(build) {
        if (build.version === undefined) {
            build.version = '0.0.1';
            build.configuration = _slorm_api_1.DEFAULT_CONFIG;
        }
        for (let change of this.CHANGES) {
            if ((0, _slorm_api_1.compareVersions)(change.version, build.version) > 0) {
                change.update(build);
            }
        }
    }
};
BuildRetrocompatibilityService = __decorate([
    (0, core_1.Injectable)({ providedIn: 'root' })
], BuildRetrocompatibilityService);
exports.BuildRetrocompatibilityService = BuildRetrocompatibilityService;
//# sourceMappingURL=build-retrocompatibility.service.js.map